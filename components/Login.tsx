  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://wirelessmaxnetwork.com.ng/app/api/account/login/index.php",
        {
          method: "POST",
          headers: {
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-12 font-sans text-black">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <div className="mb-10">
          ...
          <img src={"./wirelessmaxnetwork_bg.png"} alt="logo" width={130} height={130} />
        </div>
