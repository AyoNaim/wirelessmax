...
export default function FintechDashboard() {
  ...
  const handleTransferCashback = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://wirelessmaxnetwork.com.ng/app/api/user/cashback-transfer/index.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ phone }),
  ...
  useEffect(() => {
    const fetchNotification = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "https://wirelessmaxnetwork.com.ng/app/api/user/notifications/index.php",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ phone }),
      ...
      >
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                "Hello, I am using the Wirelessmaxnetwork App. I would like to suggest a new service: "
              )}`,
              "_blank"
            );
          }}
        ...
        <div
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                `Hello Admin, I am ${userName}. I need assistance with the Wirelessmaxnetwork App.`
              )}`,
              "_blank"
            );
          }}
